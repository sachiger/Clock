 ...
 *                StartStopwatch; ElapseStopwatch; PrintElapsed;
 */
...
TimePack  Clock::computeDaychange(TimePack T){
  ...
  dayNum = ComputeDayOfYear(_LocT.clockDay,_LocT.clockMonth,leap)+1;
...
TimePack Clock::setDateFromDayOfYear(TimePack T, uint16_t dayNum) {
  ...
  static const uint16_t monthsTab   [13] PROGMEM = { 0, 31, 59, 90, 120,151,181,212,243,273,304,334,365 };
  //                                                 31 28  31  30  31  30  31  31  30  31  30  31
  static const uint16_t monthsTabLeap[13] PROGMEM= { 0, 31, 60, 91, 121,152,182,213,244,274,305,335,366 };
